...
INSERT INTO `at_global_setting` (`setting_id`, `setting_name`, `default_value`, `setting_value`, `mark`) VALUES (1, 'home', 'http://localhost:8080/AutoTest', NULL, '首页地址url');
...
INSERT INTO `at_user` (`USER_ID`, `USERNAME`, `real_name`, `PASSWORD`, `ROLE_ID`, `CREATE_TIME`, `status`, `last_login_time`, `if_new`) VALUES (1, 'xuwangcheng', '徐汪成', '1111', 1, '2016-09-03 19:07:47', '0', '2016-09-26 12:01:24', '1');
a
